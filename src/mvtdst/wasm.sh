...
#em++ --bind -std=c++11 -Os -I../f2c/test/emscripten -s WASM=1 -s NO_EXIT_RUNTIME=1 -s SIDE_MODULE=1 -o mvtdstpack.wasm mvtdstpack.cpp pmvnorm.cpp ../f2c/test/libf2c.a -lm
em++ --bind -std=c++11 -Os -I../f2c/libf2c/emscripten -s WASM=1 -s SIDE_MODULE=1 -o mvtdstpack.wasm mvtdstpack.cpp pmvnorm.cpp ../f2c/libf2c/emscripten/libf2c.a -lm
